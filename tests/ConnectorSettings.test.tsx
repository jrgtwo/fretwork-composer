...
// No harness mock here any more. AG-03's provisional "Run composer" trigger sat
// in this component and pulled `agentService` — and with it `agent-harness` —
// into a file that is otherwise about a URL and a token. AG-06 moved running an
// agent to `ai/CommandPanel`, and the mock went with it; `ConnectorPanel` now
// imports nothing but the settings store and the connection probe.
